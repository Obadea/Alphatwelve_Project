  ...
  return (
    <div className="swiper-container w-fit">
      ...
      >
        <SwiperSlide>
          <Card
            className="w-full h-[320px] bg-transparent"
            radius="lg"
            shadow="none"
          >
            <Image
              ...
              src="../Slide.png"
            />
            <CardFooter className="absolute bg-gradient-to-t from-black/80 to-transparent bottom-0 z-10 text-xs flex-col items-start gap-3 pb-4 text-white">
        ...
        <SwiperSlide>
          ...
          >
            <Image
              ...
              src="../Slide-1.png"
            />
            <CardFooter className="absolute bg-black/40 bottom-0 z-10 text-xs flex-col items-start gap-3 pb-4 text-white">
        ...
        <SwiperSlide>
          ...
          >
            ...
            />
            <CardFooter className="absolute bg-gradient-to-t from-black/80 to-transparent bottom-0 z-10 text-xs flex-col items-start gap-3 pb-4 text-white">
              <p className="font-semibold">Latest News & Updates (Gradient)</p>
              <p>
                Turpis interdum nunc varius ornare dignissim pretium. Massa
                ornare quis aliquet sed vitae. Sed velit nisi, fermentum erat.
                Fringilla purus, erat fringilla tincidunt quisque non.
